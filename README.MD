...
```
sudo -s
git clone https://github.com/JNPRAutomate/network_anomalies_automated_remediation_with_appformix_northstar_python.git
```
...
```
sudo -s
cd network_anomalies_automated_remediation_with_appformix_northstar_python
